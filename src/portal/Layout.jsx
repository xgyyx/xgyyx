...
const StyledAppBar = muiStyled(AppBar, { shouldForwardProp: (prop) => prop !== 'open' })
  (
    ({ theme, open }) => {
      return {
...
const Layout = () => {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      <StyledAppBar position="fixed" color={colorType} open={anchorElNav}>
        <Container maxWidth={false}>
          <Toolbar disableGutters>
            <Box sx={{ ...(anchorElNav && { display: 'none' }) }}>
              <IconButton
                size="large"
            ...
            <Box sx={{ flexGrow: 0 }}>
              <Tooltip title="Open settings">
                <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                  <Avatar alt="姚彦勋" src="/static/images/avatar/2.jpg" />
                </IconButton>
              </Tooltip>
              <Menu
                sx={{ mt: '45px' }}
      ...
      >
        ...
        {navigations.map((childGroup, index) => (
          <React.Fragment key={index}>
            <Divider />
            <List>
              {childGroup.map((text, index) => (
